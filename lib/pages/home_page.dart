...
class _HomePageState extends State<HomePage> {
  List<NewsModel> photos = [];

  Future<List<NewsModel>> getPhotoList() async {
    ...
    if(response.statusCode == 200){
      for(var photo in data){
        photos.add(NewsModel.fromJson(photo));
      }
      return photos;
    }
    return photos;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Ukraine's President Zelenskiy to BBC: Blood money being paid",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 16,
